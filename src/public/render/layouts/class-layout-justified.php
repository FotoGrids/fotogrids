...
final class Layout_Justified implements Layout {
    ...
    public function wrapper_data_attrs( Render_Context $render_context ): array {
        ...
        if ( ! in_array( $last_row, [ 'justify', 'nojustify', 'left', 'center', 'right', 'hide' ], true ) ) {
            $last_row = 'nojustify';
        }
        ...
        if ( ! in_array( $page_trailing_row, [ 'fill', 'match' ], true ) ) {
    ...
    public function style_vars( Render_Context $render_context ): array {
        $row_height = $render_context->settings['layout_justified_row_height'] ?? [];
