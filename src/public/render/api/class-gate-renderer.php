...
final class Gate_Renderer {
    ...
    public static function render(
        ...
        $gap_desktop = self::resolve_gap( $layout->responsive_spacing['desktop'] ?? [] );
        $gap_tablet  = self::resolve_gap( $layout->responsive_spacing['tablet']  ?? [] );
        $gap_mobile  = self::resolve_gap( $layout->responsive_spacing['mobile']  ?? [] );
