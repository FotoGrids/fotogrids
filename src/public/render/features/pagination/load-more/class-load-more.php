...
final class Load_More implements Feature {
	...
	private const ALLOWED_ALIGNMENTS = array( 'left', 'center', 'right' );
	...
	public function html_appendix( Render_Context $render_context ): string {
		...
		$wrapper_classes = array( 'fg-pagination', 'fg-pagination--load-more' );
		if ( $is_full ) {
	...
	public function style_vars( Render_Context $render_context ): array {
		// Shared button styling vars come from Pagination_Common::common_style_vars().
