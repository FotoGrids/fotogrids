 ...
 *   data-fg-lb-info-panel           "off"                            present = info panel disabled (attr absent = enabled)
 *   data-fg-lb-info-default         "closed"                         present = panel starts collapsed (attr absent = open)
 ...
 *   data-fg-lb-info-panel         "off"   (absent = info panel enabled)
 *   data-fg-lb-info-default       "closed"   (absent = panel starts open)
...
function readSettings(galleryEl) {
	...
	return {
		...
		toolbarBtnBorder: d.fgLbToolbarBtnBorder || null,
		toolbarBtnColor: d.fgLbToolbarBtnColor || null,
		toolbarBtnBgHover: d.fgLbToolbarBtnBgHover || null,
		toolbarBtnBorderHover: d.fgLbToolbarBtnBorderHover || null,
		toolbarBtnHover: d.fgLbToolbarBtnHover || null,
		toolbarBtnBgActive: d.fgLbToolbarBtnBgActive || null,
		toolbarBtnBorderActive: d.fgLbToolbarBtnBorderActive || null,
		toolbarBtnActiveColor: d.fgLbToolbarBtnActiveColor || null,
		toolbarBtnBgFocus: d.fgLbToolbarBtnBgFocus || null,
		toolbarBtnBorderFocus: d.fgLbToolbarBtnBorderFocus || null,
		toolbarBtnFocusColor: d.fgLbToolbarBtnFocusColor || null,
		arrowBg: d.fgLbArrowBg || null,
		arrowBorder: d.fgLbArrowBorder || null,
		arrowColor: d.fgLbArrowColor || null,
		arrowBgHover: d.fgLbArrowBgHover || null,
		arrowBorderHover: d.fgLbArrowBorderHover || null,
		arrowHoverColor: d.fgLbArrowHoverColor || null,
		arrowBgActive: d.fgLbArrowBgActive || null,
		arrowBorderActive: d.fgLbArrowBorderActive || null,
		arrowActiveColor: d.fgLbArrowActiveColor || null,
		arrowBgFocus: d.fgLbArrowBgFocus || null,
		arrowBorderFocus: d.fgLbArrowBorderFocus || null,
		arrowFocusColor: d.fgLbArrowFocusColor || null,
		bulletBg: d.fgLbBulletBg || null,
		bulletBorder: d.fgLbBulletBorder || null,
		bulletHoverBg: d.fgLbBulletHoverBg || null,
		bulletHoverBorder: d.fgLbBulletHoverBorder || null,
		bulletActiveBg: d.fgLbBulletActiveBg || null,
		bulletActiveBorder: d.fgLbBulletActiveBorder || null,
		bulletFocusBg: d.fgLbBulletFocusBg || null,
		bulletFocusBorder: d.fgLbBulletFocusBorder || null,
		bulletWidth: d.fgLbBulletWidth || null,
		bulletHeight: d.fgLbBulletHeight || null,
		bulletRadius: d.fgLbBulletRadius || null,
		bulletBorderWidth: d.fgLbBulletBorderWidth || null,
		bulletSpacing: d.fgLbBulletSpacing || null,
		thumbsBg: d.fgLbThumbsBg || null,
		thumbBorderColor: d.fgLbThumbBorderColor || null,
		thumbHoverBorderColor: d.fgLbThumbHoverBorderColor || null,
		thumbActiveColor: d.fgLbThumbActiveColor || null,
		thumbFocusBorderColor: d.fgLbThumbFocusBorderColor || null,
		...
		dotWidth: d.fgLbBulletWidth || '12px',
		dotHeight: d.fgLbBulletHeight || '12px',
		dotRadius: d.fgLbBulletRadius || '50%',
		dotBorderWidth: d.fgLbBulletBorderWidth || '2px',
		...
		overlayBlur:
			d.fgLbOverlayBlur !== undefined
				? parseInt(d.fgLbOverlayBlur, 10)
				: 8,
		preloadSlides:
			d.fgLbPreloadSlides !== undefined
				? parseInt(d.fgLbPreloadSlides, 10)
				: 2,
		infoPanelEnabled: d.fgLbInfoPanel !== 'off',
		infoPanelDefault: d.fgLbInfoDefault === 'closed' ? 'closed' : 'open',
		infoLocation: d.fgLbInfoLocation || 'right',
		infoBlocks:
			d.fgLbInfoBlocks !== undefined
				? d.fgLbInfoBlocks.split(' ').filter(Boolean)
				: null,
		...
		hideArrowsAtEnds: galleryEl.hasAttribute(
			'data-fg-lb-hide-arrows-at-ends'
		),
		progressStyle: d.fgLbProgressStyle || 'bar',
		progressBarLoc: d.fgLbProgressBarLoc || 'bottom',
		progressPauseOn: d.fgLbProgressPauseOn
			? d.fgLbProgressPauseOn.split(' ').filter(Boolean)
			: ['image_hover'],
		progressStop: galleryEl.hasAttribute('data-fg-lb-progress-stop'),
		progressControls: galleryEl.hasAttribute(
			'data-fg-lb-progress-controls'
		),
...
function buildSlideFromTrigger(triggerEl) {
	...
	const sequenceIndex =
		sequenceIndexRaw !== null && sequenceIndexRaw !== ''
	...
	if (videoEl) {
		...
		slide.embedSettings = parseEmbedSettings(
			videoEl.dataset.fgEmbedSettings
		);
...
function buildVimeoEmbedSrc(embedId, settings, forceAutoplay) {
	...
	if (
		typeof settings.controls_color === 'string' &&
...
function buildSlideFromApi(apiSlide) {
	return {
		...
		exif:
			apiSlide.exif && typeof apiSlide.exif === 'object'
				? apiSlide.exif
				: null,
		...
		embedSettings:
			...
			typeof apiSlide.embed_settings === 'object'
				? apiSlide.embed_settings
				: {},
	};
}
...
function isGalleryPaginated(galleryEl) {
	return (
		galleryEl.dataset.fgPaginated === 'true' ||
...
const THEME_VARS = {
	dark: {
		...
		toolbarBtnBg: 'rgba(0, 0, 0, 0)',
		toolbarBtnBorder: 'rgba(0, 0, 0, 0)',
		toolbarBtnColor: 'rgba(255, 255, 255, 0.7)',
		toolbarBtnBgHover: 'rgba(0, 0, 0, 0)',
		toolbarBtnBorderHover: 'rgba(0, 0, 0, 0)',
		toolbarBtnHover: 'rgba(255, 255, 255, 1)',
		toolbarBtnBgActive: 'rgba(255, 255, 255, 0.15)',
		toolbarBtnBorderActive: 'rgba(0, 0, 0, 0)',
		toolbarBtnActiveColor: 'rgba(255, 255, 255, 1)',
		toolbarBtnBgFocus: 'rgba(0, 0, 0, 0)',
		toolbarBtnBorderFocus: 'rgba(0, 0, 0, 0)',
		toolbarBtnFocusColor: 'rgba(255, 255, 255, 1)',
		arrowBg: 'rgba(0, 0, 0, 0.45)',
		arrowBorder: 'rgba(0, 0, 0, 0)',
		arrowColor: 'rgba(255, 255, 255, 1)',
		arrowBgHover: 'rgba(0, 0, 0, 0.75)',
		arrowBorderHover: 'rgba(0, 0, 0, 0)',
		arrowHoverColor: 'rgba(255, 255, 255, 1)',
		arrowBgActive: 'rgba(0, 0, 0, 0.75)',
		arrowBorderActive: 'rgba(0, 0, 0, 0)',
		arrowActiveColor: 'rgba(255, 255, 255, 1)',
		arrowBgFocus: 'rgba(0, 0, 0, 0.75)',
		arrowBorderFocus: 'rgba(0, 0, 0, 0)',
		arrowFocusColor: 'rgba(255, 255, 255, 1)',
		bulletBg: 'rgba(0, 0, 0, 0)',
		bulletBorder: 'rgba(255, 255, 255, 0.7)',
		bulletHoverBg: 'rgba(255, 255, 255, 0.3)',
		bulletHoverBorder: 'rgba(255, 255, 255, 0.8)',
		bulletActiveBg: 'var(--fg-colors-blue)',
		bulletActiveBorder: 'var(--fg-colors-blue)',
		bulletFocusBg: 'var(--fg-colors-blue)',
		bulletFocusBorder: 'var(--fg-colors-blue)',
		thumbsBg: 'rgba(0, 0, 0, 0.7)',
		thumbBorderColor: 'rgba(0, 0, 0, 0)',
		thumbHoverBorderColor: 'rgba(255, 255, 255, 0.45)',
		thumbActiveColor: 'var(--fg-colors-blue)',
		thumbFocusBorderColor: 'var(--fg-colors-blue)',
	...
	light: {
		...
		toolbarBtnBgActive: 'rgba(0, 0, 0, 0.1)',
		toolbarBtnBorderActive: 'rgba(0, 0, 0, 0)',
		toolbarBtnActiveColor: 'rgba(0, 0, 0, 1)',
		toolbarBtnBgFocus: 'rgba(0, 0, 0, 0)',
		toolbarBtnBorderFocus: 'rgba(0, 0, 0, 0)',
		toolbarBtnFocusColor: 'rgba(0, 0, 0, 1)',
		...
		arrowBgActive: 'rgba(255, 255, 255, 1)',
		arrowBorderActive: 'rgba(0, 0, 0, 0)',
		arrowActiveColor: 'rgba(0, 0, 0, 1)',
		arrowBgFocus: 'rgba(255, 255, 255, 1)',
		arrowBorderFocus: 'rgba(0, 0, 0, 0)',
		arrowFocusColor: 'rgba(0, 0, 0, 1)',
		bulletBg: 'rgba(0, 0, 0, 0)',
		bulletBorder: 'rgba(0, 0, 0, 0.7)',
		bulletHoverBg: 'rgba(0, 0, 0, 0.3)',
		bulletHoverBorder: 'rgba(0, 0, 0, 0.8)',
		bulletActiveBg: 'var(--fg-colors-blue)',
		bulletActiveBorder: 'var(--fg-colors-blue)',
		bulletFocusBg: 'var(--fg-colors-blue)',
		bulletFocusBorder: 'var(--fg-colors-blue)',
		...
		thumbBorderColor: 'rgba(0, 0, 0, 0)',
		thumbHoverBorderColor: 'rgba(0, 0, 0, 0.3)',
		thumbActiveColor: 'var(--fg-colors-blue)',
		thumbFocusBorderColor: 'var(--fg-colors-blue)',
...
function buildVarsCSS(s) {
	...
	const colors =
		s.theme === 'custom'
			? {
					...
					toolbarBtnBg: s.toolbarBtnBg || base.toolbarBtnBg,
					toolbarBtnBorder:
						s.toolbarBtnBorder || base.toolbarBtnBorder,
					toolbarBtnColor: s.toolbarBtnColor || base.toolbarBtnColor,
					toolbarBtnBgHover:
						s.toolbarBtnBgHover || base.toolbarBtnBgHover,
					toolbarBtnBorderHover:
						s.toolbarBtnBorderHover || base.toolbarBtnBorderHover,
					toolbarBtnHover: s.toolbarBtnHover || base.toolbarBtnHover,
					toolbarBtnBgActive:
						s.toolbarBtnBgActive || base.toolbarBtnBgActive,
					toolbarBtnBorderActive:
						s.toolbarBtnBorderActive || base.toolbarBtnBorderActive,
					toolbarBtnActiveColor:
						s.toolbarBtnActiveColor || base.toolbarBtnActiveColor,
					toolbarBtnBgFocus:
						s.toolbarBtnBgFocus || base.toolbarBtnBgFocus,
					toolbarBtnBorderFocus:
						s.toolbarBtnBorderFocus || base.toolbarBtnBorderFocus,
					toolbarBtnFocusColor:
						s.toolbarBtnFocusColor || base.toolbarBtnFocusColor,
					arrowBg: s.arrowBg || base.arrowBg,
					arrowBorder: s.arrowBorder || base.arrowBorder,
					arrowColor: s.arrowColor || base.arrowColor,
					arrowBgHover: s.arrowBgHover || base.arrowBgHover,
					arrowBorderHover:
						s.arrowBorderHover || base.arrowBorderHover,
					arrowHoverColor: s.arrowHoverColor || base.arrowHoverColor,
					arrowBgActive: s.arrowBgActive || base.arrowBgActive,
					arrowBorderActive:
						s.arrowBorderActive || base.arrowBorderActive,
					arrowActiveColor:
						s.arrowActiveColor || base.arrowActiveColor,
					arrowBgFocus: s.arrowBgFocus || base.arrowBgFocus,
					arrowBorderFocus:
						s.arrowBorderFocus || base.arrowBorderFocus,
					arrowFocusColor: s.arrowFocusColor || base.arrowFocusColor,
					bulletBg: s.bulletBg || base.bulletBg,
					bulletBorder: s.bulletBorder || base.bulletBorder,
					bulletHoverBg: s.bulletHoverBg || base.bulletHoverBg,
					bulletHoverBorder:
						s.bulletHoverBorder || base.bulletHoverBorder,
					bulletActiveBg: s.bulletActiveBg || base.bulletActiveBg,
					bulletActiveBorder:
						s.bulletActiveBorder || base.bulletActiveBorder,
					bulletFocusBg: s.bulletFocusBg || base.bulletFocusBg,
					bulletFocusBorder:
						s.bulletFocusBorder || base.bulletFocusBorder,
					thumbsBg: s.thumbsBg || base.thumbsBg,
					thumbBorderColor:
						s.thumbBorderColor || base.thumbBorderColor,
					thumbHoverBorderColor:
						s.thumbHoverBorderColor || base.thumbHoverBorderColor,
					thumbActiveColor:
						s.thumbActiveColor || base.thumbActiveColor,
					thumbFocusBorderColor:
						s.thumbFocusBorderColor || base.thumbFocusBorderColor,
	...
	const lines = [
		...
		`  --fg-lb-dot-width:                    ${s.dotWidth};`,
		`  --fg-lb-dot-height:                   ${s.dotHeight};`,
		`  --fg-lb-dot-radius:                   ${s.dotRadius};`,
		`  --fg-lb-dot-border-width:             ${s.dotBorderWidth};`,
		...
		`  --fg-lb-color-toolbar-btn-bg:         ${colors.toolbarBtnBg};`,
		`  --fg-lb-color-toolbar-btn-border:     ${colors.toolbarBtnBorder};`,
		`  --fg-lb-color-toolbar-icon:           ${colors.toolbarBtnColor};`,
		`  --fg-lb-color-toolbar-btn-bg-hover:   ${colors.toolbarBtnBgHover};`,
		`  --fg-lb-color-toolbar-btn-border-hover: ${colors.toolbarBtnBorderHover};`,
		`  --fg-lb-color-toolbar-icon-hover:     ${colors.toolbarBtnHover};`,
		`  --fg-lb-color-toolbar-btn-bg-active:  ${colors.toolbarBtnBgActive};`,
		`  --fg-lb-color-toolbar-btn-border-active: ${colors.toolbarBtnBorderActive};`,
		`  --fg-lb-color-toolbar-btn-active:     ${colors.toolbarBtnBgActive};`,
		`  --fg-lb-color-toolbar-icon-active:    ${colors.toolbarBtnActiveColor};`,
		`  --fg-lb-color-toolbar-btn-bg-focus:   ${colors.toolbarBtnBgFocus};`,
		`  --fg-lb-color-toolbar-btn-border-focus: ${colors.toolbarBtnBorderFocus};`,
		`  --fg-lb-color-toolbar-icon-focus:     ${colors.toolbarBtnFocusColor};`,
		`  --fg-lb-color-nav-bg:                 ${colors.arrowBg};`,
		`  --fg-lb-color-nav-border:             ${colors.arrowBorder};`,
		`  --fg-lb-color-nav-icon:               ${colors.arrowColor};`,
		`  --fg-lb-color-nav-bg-hover:           ${colors.arrowBgHover};`,
		`  --fg-lb-color-nav-border-hover:       ${colors.arrowBorderHover};`,
		`  --fg-lb-color-nav-icon-hover:         ${colors.arrowHoverColor};`,
		`  --fg-lb-color-nav-bg-active:          ${colors.arrowBgActive};`,
		`  --fg-lb-color-nav-border-active:      ${colors.arrowBorderActive};`,
		`  --fg-lb-color-nav-icon-active:        ${colors.arrowActiveColor};`,
		`  --fg-lb-color-nav-bg-focus:           ${colors.arrowBgFocus};`,
		`  --fg-lb-color-nav-border-focus:       ${colors.arrowBorderFocus};`,
		`  --fg-lb-color-nav-icon-focus:         ${colors.arrowFocusColor};`,
		`  --fg-lb-color-dot-bg:                 ${colors.bulletBg};`,
		`  --fg-lb-color-dot-border:             ${colors.bulletBorder};`,
		`  --fg-lb-color-dot-hover-bg:           ${colors.bulletHoverBg};`,
		`  --fg-lb-color-dot-hover-border:       ${colors.bulletHoverBorder};`,
		`  --fg-lb-color-dot-active-bg:          ${colors.bulletActiveBg};`,
		`  --fg-lb-color-dot-active-border:      ${colors.bulletActiveBorder};`,
		`  --fg-lb-color-dot-focus-bg:           ${colors.bulletFocusBg};`,
		`  --fg-lb-color-dot-focus-border:       ${colors.bulletFocusBorder};`,
		`  --fg-lb-color-thumbs-bg:              ${colors.thumbsBg};`,
		`  --fg-lb-color-thumb-border:           ${colors.thumbBorderColor};`,
		`  --fg-lb-color-thumb-hover-border:     ${colors.thumbHoverBorderColor};`,
		`  --fg-lb-color-thumb-active:           ${colors.thumbActiveColor};`,
		`  --fg-lb-color-thumb-focus-border:     ${colors.thumbFocusBorderColor};`,
		`  --fg-lb-color-info-bg:                ${colors.infoBg};`,
		`  --fg-lb-color-info-block-bg:          ${colors.infoBlockBg};`,
		`  --fg-lb-color-info-text:              ${colors.infoText};`,
		`  --fg-lb-color-info-block-header:             ${colors.infoTitle};`,
	...
	if (s.infoBlocksStyle === 'divided' && s.infoBlockDivider) {
		lines.push(
			`  --fg-lb-color-info-block-divider:     ${s.infoBlockDivider};`
		);
	}
	...
	if (s.thumbFilterHover) {
		lines.push(
			`  --fg-lb-thumb-filter-hover:           ${s.thumbFilterHover};`
		);
	}
	if (s.fullFilter) {
	...
	if (s.fullFilterHover) {
		lines.push(
			`  --fg-lb-full-filter-hover:            ${s.fullFilterHover};`
		);
	}
...
const FGLB_ICON_PAUSE =
	'<svg width="100%" height="100%" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="4" y="4" width="6" height="16" rx="1.5" /><rect x="14" y="4" width="6" height="16" rx="1.5" /></svg>';
const FGLB_ICON_PLAY =
...
// Toolbar buttons
const FGLB_ICON_CLOSE =
	'<svg width="100%" height="100%" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true"><path d="M19 5L5 19M5 5L19 19" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>';
const FGLB_ICON_INFO =
	'<svg width="100%" height="100%" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true"><path d="M12 16V12M12 8H12.01M22 12C22 17.5228 17.5228 22 12 22C6.47715 22 2 17.5228 2 12C2 6.47715 6.47715 2 12 2C17.5228 2 22 6.47715 22 12Z" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>';
const FGLB_ICON_SHARE =
...
class FotoGridsLightbox {
	...
	_createDialog() {
		...
		if (spinnerEl && window.fotogridsLoadingIcon?.svg) {
			const uid =
				'fglbs' +
				(FotoGridsLightbox._spinnerIdCounter =
					(FotoGridsLightbox._spinnerIdCounter || 0) + 1);
			spinnerEl.innerHTML = window.fotogridsLoadingIcon.svg.replace(
				/__FG_ID__/g,
				uid
			);
		}
		...
		dlg.addEventListener('click', (e) => {
			if (
				...
				(e.target === dlg ||
					e.target.classList.contains('fg-lb-backdrop'))
			) {
				this.close();
			}
		});
		...
		mediaWrap.addEventListener('touchstart', this._onTouchStart, {
			passive: true,
		});
		mediaWrap.addEventListener('touchmove', this._onTouchMove, {
			passive: false,
		});
		mediaWrap.addEventListener('dblclick', (e) =>
			this._onZoomClick(e, true)
		);
	...
	open(galleryEl, index) {
		...
		if (isGalleryPaginated(galleryEl)) {
			...
			const startIndex =
				clickedSlide && clickedSlide.sequenceIndex != null
			...
			this.index = Math.max(
				0,
				Math.min(index, Math.max(0, this._total - 1))
			);
		}
	...
	close() {
		...
		if (item && item.triggerEl) {
			...
			const candidates = this.galleryEl.querySelectorAll(
	...
	_fetchSlideRange(offset, limit) {
		...
		const promise = fetch(url, {
			...
			.catch(() => {
				/* silent - manual nav still works on cache miss */
			})
			.then(() => {
	...
	_clampZoomOffset() {
		...
		this._zoomOffset.x = Math.max(
			-maxX,
			Math.min(maxX, this._zoomOffset.x)
		);
		this._zoomOffset.y = Math.max(
			-maxY,
			Math.min(maxY, this._zoomOffset.y)
		);
	}
	...
	_applySettings() {
		...
		dlg.removeAttribute('data-fg-lb-info-default');
		...
		// Info panel visibility - data attribute on dialog, location class on content.
		const contentEl = dlg.querySelector('.fg-lb-content');
		contentEl.className = 'fg-lb-content';
		if (!s.infoPanelEnabled) {
			dlg.setAttribute('data-fg-lb-info-panel', 'off');
		} else if (s.infoPanelDefault === 'closed') {
			dlg.setAttribute('data-fg-lb-info-default', 'closed');
		}
		if (s.infoPanelEnabled) {
	...
	_applyDynamicDOM(s) {
		...
		const noInfoBlocks =
			Array.isArray(s.infoBlocks) && s.infoBlocks.length === 0;

		if (!s.infoPanelEnabled || noInfoBlocks) {
			infoEl?.remove();
			toggleBtn?.remove();
		} else {
			...
			const startClosed = s.infoPanelDefault === 'closed';
			infoEl.hidden = startClosed;
			...
			// Sync toggle state to the panel's starting visibility (covers both
			// freshly-created buttons and a gallery reopened with new settings).
			toggleBtn.setAttribute(
				'aria-pressed',
		...
		if (this._sharingConfig()) {
			if (!shareBtn) {
				...
				shareBtn.addEventListener('click', () =>
					this._toggleShareMenu(shareBtn)
				);
				const closeBtn = toolbarEnd.querySelector('.fg-lb-close');
		...
		if (s.fullscreen) {
			if (!fsBtn) {
				...
				document.addEventListener('fullscreenchange', () => {
					...
					this.dialog.toggleAttribute(
						'data-fg-lb-fullscreen-active',
						active
					);
	...
	/**
	 * Render the combined title / caption / description text block.
	 *
	 * Title (if selected and present) is always first; caption and description
	 * follow in their selected order. Title and caption are immediate; the
	 * description line reserves its ordered slot and is filled when REST data
	 * resolves. The block carries data-fg-lb-block="text" and is appended in
	 ...
	 * @returns {void}
	 */
	_renderTextBlock(infoEl, blocks, item) {
		const blockEl = document.createElement('div');
		blockEl.className = 'fg-lb-info-block';
		blockEl.dataset.fgLbBlock = 'text';

		const wantsTitle = blocks.includes('title');
		const titleText = (item.title || '').trim();
		if (wantsTitle && titleText !== '') {
			const titleEl = document.createElement('p');
			titleEl.className = 'fg-lb-info-title';
			titleEl.textContent = titleText;
			blockEl.appendChild(titleEl);
		}

		// caption + description in their selected order. Title is excluded -
		// it is always rendered first, above, regardless of its slot.
		const ordered = blocks.filter(
			(b) => b === 'caption' || b === 'description'
		);
		ordered.forEach((b) => {
			if (b === 'caption') {
				...
				// REST-fetched. Reserve an ordered, empty <p> so the
				// description lands in its selected position when filled.
		...
		// Append only when there is something to show now or a description
		// slot to fill later. An all-empty block is dropped so no empty box
		// flashes; if description later arrives, _fillInfoBlocksFromData
		// recreates the block.
		const hasImmediate = blockEl.querySelector(
			'.fg-lb-info-title, .fg-lb-info-caption'
		);
		const hasDescriptionSlot = blockEl.querySelector(
			'.fg-lb-info-description'
		);
		if (hasImmediate || hasDescriptionSlot) {
	...
	_sharingConfig() {
		...
		if (
			!config.enabled ||
			!Array.isArray(config.placements) ||
			!config.placements.includes('lightbox')
		) {
			return null;
		}
		return config;
	...
	_toggleShareMenu(btn) {
		if (
			!window.FgTooltip ||
			typeof window.FgTooltip.showInteractive !== 'function'
		) {
			return;
		}
		...
		const opened = window.FgTooltip.showInteractive(btn, bar, {
			dir: 'below',
		});
	...
	_renderInfoBlocks(item) {
		...
		// title / caption / description render together in a single text block.
		// The block takes the position of whichever of the three appears first
		// in the selection; within the block, title (if selected) is always
		// first, then caption and description in their selected order.
		const TEXT_BLOCKS = ['title', 'caption', 'description'];
		const firstTextIndex = blocks.findIndex((b) => TEXT_BLOCKS.includes(b));
		...
		const creditSource =
			s.creditSource === 'exif' || s.creditSource === 'xmp'
				? s.creditSource
				: 'item_meta';
	...
	_fillInfoBlocksFromData(infoEl, blocks, data) {
		...
		blocks.forEach((blockId) => {
			// Description lives inside the combined text block, in its selected
			// slot. The slot <p> is pre-rendered (hidden) by _renderTextBlock;
			// fill and reveal it here, or rebuild the text block if absent.
			if (blockId === 'description') {
				const desc = (data.description || '').trim();
				const textBlockEl = infoEl.querySelector(
					'[data-fg-lb-block="text"]'
				);
				if (textBlockEl) {
					const target = textBlockEl.querySelector(
						'.fg-lb-info-description'
					);
					if (target) {
						if (desc !== '') {
					...
					// No text block in the DOM (title + caption were empty);
					// rebuild it now that description has content.
					const blockEl = document.createElement('div');
					blockEl.className = 'fg-lb-info-block';
					blockEl.dataset.fgLbBlock = 'text';
					const descEl = document.createElement('p');
					...
					blockEl.appendChild(descEl);
					// Insert at the text block's selected position: before the
					// next non-text block already in the DOM.
					const textBlocks = ['title', 'caption', 'description'];
			...
			if (blockId === 'exif') {
				...
				if (!exif || !fields || fields.length === 0) {
					blockEl.remove();
					return;
				}
	...
	_fillInfoBlocksNoData(infoEl, blocks) {
		...
		blocks.forEach((blockId) => {
			...
			if (blockId === 'description') {
				...
				const descEl = textBlockEl
					? textBlockEl.querySelector('.fg-lb-info-description')
					: null;
				if (descEl) {
					descEl.remove();
				}
				if (textBlockEl && textBlockEl.children.length === 0) {
					textBlockEl.remove();
				}
				return;
			}
	...
	_resumeAuto() {
		...
		this._autoStartedAt =
			Date.now() - (this.settings.autoDelay * 1000 - remaining);
		...
		if (pauseOn.includes('thumbnail_hover')) {
			...
			if (thumbsEl) {
				...
				thumbsEl.addEventListener(
					'mouseenter',
					this._onThumbsMouseEnter
				);
				thumbsEl.addEventListener(
					'mouseleave',
					this._onThumbsMouseLeave
				);
	...
	_teardownAutoListeners() {
		if (this._onImgMouseEnter && this._pauseOnImgEl) {
			this._pauseOnImgEl.removeEventListener(
				'mouseenter',
				this._onImgMouseEnter
			);
			this._pauseOnImgEl.removeEventListener(
				'mouseleave',
				this._onImgMouseLeave
			);
		...
		if (this._onThumbsMouseEnter && this._pauseOnThumbsEl) {
			this._pauseOnThumbsEl.removeEventListener(
				'mouseenter',
				this._onThumbsMouseEnter
			);
			this._pauseOnThumbsEl.removeEventListener(
	...
	_onTouchMove(e) {
		...
		const next = Math.max(
			FGLB_ZOOM_MIN,
			Math.min(max, this._pinchStartScale * (dist / this._pinchStartDist))
		);
...
class FotoGridsLightboxInit {
	...
	_activateGallery(galleryEl) {
		// The lightbox trigger anchors are stamped for every lightbox variant,
