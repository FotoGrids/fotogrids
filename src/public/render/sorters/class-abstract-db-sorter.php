...
abstract class Abstract_Db_Sorter {
	...
	protected function batch_fetch( array $item_ids ): array {
		...
		// phpcs:disable WordPress.DB.PreparedSQL.InterpolatedNotPrepared, WordPress.DB.PreparedSQLPlaceholders.UnfinishedPrepare -- $placeholders is a generated list of %d tokens.
		$rows = $wpdb->get_results( // phpcs:ignore WordPress.DB.DirectDatabaseQuery.DirectQuery, WordPress.DB.DirectDatabaseQuery.NoCaching -- Batch lookup; no core API returns this shape.
			$wpdb->prepare(
