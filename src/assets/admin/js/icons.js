...
const FotoGridsIcons = {
    ...
    behavior: `<svg width="20" height="20" viewBox="0 0 20 20" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
        <path d="M10 2C8.9 2 8 2.9 8 4v1.38c-.83-.33-1.72-.5-2.61-.5C3.61 4.88 2 6.49 2 8.27s1.61 3.39 3.39 3.39c.89 0 1.78-.17 2.61-.5V12c0 1.1.9 2 2 2s2-.9 2-2v-1.38c.83.33 1.72.5 2.61.5 1.78 0 3.39-1.61 3.39-3.39S16.39 4.88 14.61 4.88c-.89 0-1.78.17-2.61.5V4c0-1.1-.9-2-2-2zm0 2c.55 0 1 .45 1 1v6c0 .55-.45 1-1 1s-1-.45-1-1V5c0-.55.45-1 1-1z"/>
    </svg>`,
    ...
    layout_carousel: `<svg width="100%" height="100%" viewBox="0 0 64 48" fill="none" xmlns="http://www.w3.org/2000/svg">
        <rect x="8" y="8" width="20" height="32" rx="2" fill="currentColor" opacity="0.3"/>
        <rect x="16" y="4" width="32" height="40" rx="2" fill="currentColor" opacity="0.8"/>
        <rect x="36" y="8" width="20" height="32" rx="2" fill="currentColor" opacity="0.3"/>
        <circle cx="32" cy="42" r="2" fill="currentColor" opacity="0.5"/>
        <circle cx="26" cy="42" r="1.5" fill="currentColor" opacity="0.3"/>
        <circle cx="38" cy="42" r="1.5" fill="currentColor" opacity="0.3"/>
    </svg>`,
    ...
    layout_video: `<svg width="100%" height="100%" viewBox="0 0 64 48" fill="none" xmlns="http://www.w3.org/2000/svg">
        <rect x="4" y="4" width="38" height="28" rx="2" fill="currentColor" opacity="0.8"/>
        <polygon points="20,14 28,18 20,22" fill="white" opacity="0.9"/>
        <rect x="46" y="4" width="14" height="8" rx="1" fill="currentColor" opacity="0.6"/>
        <rect x="46" y="14" width="14" height="8" rx="1" fill="currentColor" opacity="0.6"/>
        <rect x="46" y="24" width="14" height="8" rx="1" fill="currentColor" opacity="0.6"/>
        <circle cx="22" cy="36" r="2" fill="currentColor" opacity="0.4"/>
        <rect x="26" y="34" width="8" height="4" rx="1" fill="currentColor" opacity="0.4"/>
    ...
    'chevron-right': `<svg width="24" height="24" viewBox="0 0 24 24" fill="none">
        <path d="M9 18l6-6-6-6" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
    </svg>`,
    ...
    'search-sm': `<svg width="100%" height="100%" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M21 21L15.0001 15M17 10C17 13.866 13.866 17 10 17C6.13401 17 3 13.866 3 10C3 6.13401 6.13401 3 10 3C13.866 3 17 6.13401 17 10Z" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
    </svg>`,

    'search-md': `<svg width="100%" height="100%" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
