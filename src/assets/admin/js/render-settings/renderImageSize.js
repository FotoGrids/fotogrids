...
window.FotoGridsRenderSettings.renderImageSize = (setting, currentValue, isDisabled, {
    updateSetting,
    renderIcon,
    isProActive,
    isDefaultsMode,
    ...
    const renderAdditionalContent = (selectedOption, options, currentValue) => {
        ...
        if (selectedOption.width && selectedOption.height) {
            sizeInfo = React.createElement('span', { key: 'size' }, [
                React.createElement('strong', null, __('Image Size:', 'fotogrids')),
        ...
        const cropText = selectedOption.crop !== undefined
            ? React.createElement('span', { key: 'crop' }, [
                React.createElement('strong', null, __('Crop:', 'fotogrids')),
        ...
        return React.createElement('div', {
            ...
            sizeInfo,
            cropText && React.createElement('span', { key: 'separator' }, '. '),
            cropText
        ].filter(Boolean));
    };
