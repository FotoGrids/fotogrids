...
window.FotoGridsRenderSettings.renderExternalUrlManager = (
	...
	if (!canEditPosts) {
		return h(
			...
			{
				className:
					'fotogrids-external-url-manager fotogrids-external-url-manager--no-permission',
			},
			[
				h(
					'div',
	...
	if (loadingItems) {
		return h(
			...
			{
				className:
					'fotogrids-external-url-manager fotogrids-external-url-manager--loading',
			},
			[
				h(
					'div',
					...
					galleryItems.map((itemId) =>
						h(
							'div',
							{
								key: itemId,
								className:
									'fotogrids-item-url-item fotogrids-item-url-item--skeleton',
							},
							[
								h('div', {
									className:
	...
	if (itemError) {
		return h(
			...
			{
				className:
					'fotogrids-external-url-manager fotogrids-external-url-manager--error',
			},
			[
				h(
					'div',
													...
													h('input', {
														...
														onBlur: (e) => {
															...
															if (
																...
																e.target.className =
																	'fotogrids-input fotogrids-input--valid';
															} else if (
																!validation.valid &&
																newUrl
															) {
																e.target.className =
																	'fotogrids-input fotogrids-input--invalid';
															} else {
																e.target.className =
																	'fotogrids-input';
															}
