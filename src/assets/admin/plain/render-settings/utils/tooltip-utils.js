...
(function () {
	...
	// Render helpers use wp.element (React) without a module system, so the
	// tooltip is a stateful class component to get refs and state without hooks.
