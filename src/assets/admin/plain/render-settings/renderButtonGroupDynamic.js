...
const ButtonGroupDynamicComponent = ({ setting, currentValue, isDisabled, updateSetting, renderIcon, getFieldState, isDefaultsMode, getOptionState, __, renderAdditionalContent }) => {
    ...
    if (loading) {
        ...
        return React.createElement('div', {
            ...
            React.createElement('label', {
                ...
                setting.label,
                showSettingBadge && ProBadge && React.createElement(ProBadge, {
                    key: 'pro-badge',
