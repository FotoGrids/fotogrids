...
window.FotoGridsRenderSettings.renderHoverEffectsGrid = (
	...
	const getCapabilityText = option => {
		const capabilities = [];
		if (option.capabilities?.title)
			capabilities.push(__('Title', 'fotogrids'));
		if (option.capabilities?.description)
			capabilities.push(__('Description', 'fotogrids'));
		if (capabilities.length === 0)
			return __('Compatible with all elements', 'fotogrids');
			...
			h(
				...
				setting.options.map((option, index) => {
					...
					const isDisabledOption =
						isDisabled || optionState !== 'editable';
					...
					return h(
						...
						[
							h(
								'div',
								{
									className: `fotogrids-hover-effect-option__preview ${
										settings.caption_placement === 'top'
											? 'fotogrids-caption-placement-top'
											: settings.caption_placement ===
												  'bottom'
												? 'fotogrids-caption-placement-bottom'
												: 'fotogrids-caption-placement-overlay'
									} ${
										settings.caption_alignment === 'left'
											? 'fotogrids-caption-alignment-left'
											: settings.caption_alignment ===
												  'center'
												? 'fotogrids-caption-alignment-center'
												: settings.caption_alignment ===
													  'right'
													? 'fotogrids-caption-alignment-right'
													: settings.caption_alignment ===
														  'justify'
														? 'fotogrids-caption-alignment-justify'
														: 'fotogrids-caption-alignment-center'
									}`,
								},
								[
									h(
										...
										{
											className:
												'fotogrids-hover-effect-option__preview-bg',
										},
										[
											h('picture', {}, [
												h('source', {
									...
									h(
										...
										{
											className:
												'fotogrids-hover-effect-option__preview-content',
										},
										[
											option.capabilities?.title &&
												h(
													'h4',
													{
														className:
															'fotogrids-hover-effect-option__preview-title',
													},
													'Item Title',
												),
											option.capabilities?.description &&
												h(
													'p',
													{
														className:
															'fotogrids-hover-effect-option__preview-description',
													},
							...
							h(
								...
								{
									className:
										'fotogrids-hover-effect-option__content',
								},
								[
									h(
										'div',
										{
											className:
												'fotogrids-hover-effect-option__info',
										},
										[
											h(
												'h4',
											...
											h(
												...
												[
													...
													h(
														...
														{
															className:
																'fotogrids-hover-effect-option__capability-icons',
														},
														[
															option.capabilities
																?.title &&
															...
															option.capabilities
																...
																h(
																	...
																	{
																		className:
																			'fotogrids-capability-icon fotogrids-capability-icon--social',
																		title: __(
																			'Social Icons',
																			'fotogrids',
																		),
