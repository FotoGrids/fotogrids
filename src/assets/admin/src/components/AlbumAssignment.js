...
const AlbumAssignment = () => {
	...
	return React.createElement(
		'div',
		{ className: 'fotogrids-album-assignment' },
		React.createElement(
			'div',
			{ className: 'fotogrids-assigned-summary' },
			React.createElement(
				'p',
				null,
				...
				React.createElement(
					...
					getAssignedAlbumsData().map((album) =>
						React.createElement(
							...
							{
								key: album.ID,
								className: 'fotogrids-assigned-album',
							},
							React.createElement(
								'div',
								{
									key: 'thumb',
									className:
										'fotogrids-assigned-album-thumb-wrap',
								},
								album.featured_item
							...
							React.createElement(
								'div',
								{
									key: 'details',
									className:
										'fotogrids-assigned-album-details',
								},
								React.createElement(
									'div',
									{
		...
		availableAlbums.length > 0 &&
			React.createElement(
				'div',
				{ className: 'fotogrids-album-search' },
				React.createElement(
					'div',
					{ className: 'fotogrids-search-input-wrapper' },
		...
		React.createElement(
			'div',
			{ className: 'fotogrids-album-list' },
						...
						filteredAlbums.map((album) =>
							React.createElement(
								...
								React.createElement(
									...
									{
										key: 'thumb',
										className: 'fotogrids-album-thumb-wrap',
									},
									album.featured_item
										? React.createElement('img', {
												src: album.featured_item,
								...
								React.createElement(
									...
									{
										key: 'details',
										className: 'fotogrids-album-details',
									},
									React.createElement(
										'div',
								...
								React.createElement(
									'button',
									{
										...
										type: 'button',
										className:
											'fg-action-button fg-action-button--add',
										onClick: () =>
		...
		React.createElement(
			'div',
			{ className: 'fotogrids-create-album' },
			React.createElement(
				'button',
				{
					type: 'button',
					className:
						'fg-button fg-button--outline fg-button--variant-primary fg-button--size-sm',
