...
const PRICING_URL = fgGoUrl('pricing', 'setup-wizard', 'pricing', 'no-key');
	...
	const handleActivate = async (e) => {
		...
		try {
			...
			if (response && response.success) {
				setSuccess(
					response.message || __('License activated.', 'fotogrids')
				);
				setLicenseKey('');
	...
	return (
		<div className="fotogrids-setup__step fotogrids-setup__step--account">
			...
			<p className="fotogrids-setup__step-subhead">
				{isPro ? (
					__(
						'You’re all set - Pro features are unlocked on this site.',
						'fotogrids'
					)
				) : (
					<>
						{__(
							'Already have a FotoGrids Pro license? Paste your key below.',
							'fotogrids'
						)}
						<br />
						{__(
							'Using the free version? Skip this step - you can always activate Pro later from the FotoGrids License page.',
							'fotogrids'
						)}
					</>
				)}
				...
				<div className="fotogrids-setup__account-active">
					...
					<div className="fotogrids-setup__account-active-body">
						...
						<span className="fotogrids-setup__account-active-text">
							{__(
								'Manage your license from FotoGrids → License.',
								'fotogrids'
							)}
						</span>
					</div>
			...
			{!loading && !isPro && (
				...
				>
					...
					{error && (
						<div
							className="fotogrids-setup__account-notice fotogrids-setup__account-notice--error"
							role="alert"
						>
							{error}
						</div>
					...
					{success && (
						<div
							className="fotogrids-setup__account-notice fotogrids-setup__account-notice--success"
							role="status"
						>
							{success}
						</div>
