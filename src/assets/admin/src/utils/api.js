...
export const saveGallery = (gallery) => {
    ...
    const path = isNew ? '/fotogrids/v1/admin/galleries' : `/fotogrids/v1/admin/galleries/${gallery.id}`;
...
export const saveAlbum = (album) => {
    ...
    const method = isNew ? 'POST' : 'PUT';
    const path = isNew ? '/fotogrids/v1/admin/albums' : `/fotogrids/v1/admin/albums/${album.id}`;
