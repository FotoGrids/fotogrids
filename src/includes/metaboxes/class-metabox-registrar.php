...
final class Metabox_Registrar {
	...
	private static function common_metabox_strings(): array {
		return array(
			...
			'folderModalTitle'                    => __( 'Add images from a folder', 'fotogrids' ),
			'folderOnServer'                      => __( 'On the server', 'fotogrids' ),
			'folderOnComputer'                    => __( 'From my computer', 'fotogrids' ),
			'folderEmpty'                         => __( 'No images in this folder.', 'fotogrids' ),
			'folderLoadFailed'                    => __( 'That folder could not be read.', 'fotogrids' ),
			'folderNoImages'                      => __( 'No images found in that folder.', 'fotogrids' ),
			'importFailed'                        => __( 'The images could not be added.', 'fotogrids' ),
			'filesSkipped'                        => __( 'files were skipped.', 'fotogrids' ),
			'notInLibrary'                        => __( 'New', 'fotogrids' ),
			'selectAll'                           => __( 'Select all', 'fotogrids' ),
			'loadMore'                            => __( 'Load more', 'fotogrids' ),
			'selectFolderTitle'                   => __( 'Select a folder to upload', 'fotogrids' ),
			'dragDropImages'                      => __( 'or drag and drop images here', 'fotogrids' ),
			'chooseFolderDescription'             => __( 'Every image in the folder and its sub-folders is uploaded to your Media Library.', 'fotogrids' ),
			'imagesReady'                         => __( 'images ready to upload', 'fotogrids' ),
			'uploadAndAdd'                        => __( 'Upload & Add', 'fotogrids' ),
			'uploading'                           => __( 'Uploading…', 'fotogrids' ),
			'zipModalTitle'                       => __( 'Add images from a ZIP file', 'fotogrids' ),
			'zipChoose'                           => __( 'Select a ZIP file to upload', 'fotogrids' ),
			'zipDragDrop'                         => __( 'or drag and drop it here', 'fotogrids' ),
			'zipInvalid'                          => __( 'That file is not a ZIP archive.', 'fotogrids' ),
			'zipFailed'                           => __( 'The archive could not be imported.', 'fotogrids' ),
			'zipExtracting'                       => __( 'Extracting images…', 'fotogrids' ),
			'zipUploadAndAdd'                     => __( 'Upload & Add', 'fotogrids' ),
			'zipImagesAdded'                      => __( 'images added.', 'fotogrids' ),
			'zipEntriesSkipped'                   => __( 'entries were skipped:', 'fotogrids' ),
			'done'                                => __( 'Done', 'fotogrids' ),
			'maxUploadSize'                       => sprintf(
