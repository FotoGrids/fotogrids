...
final class Watermark_Settings_Store {
	...
	const FONTS = array(
		...
		'playfair-display' => array(
			...
			'family' => 'FG Playfair Display',
		),
		'merriweather'     => array(
			'file'   => 'Merriweather-SemiBold.ttf',
			'family' => 'FG Merriweather',
		),
		'jetbrains-mono'   => array(
			'file'   => 'JetBrainsMono-SemiBold.ttf',
			'family' => 'FG JetBrains Mono',
		),
		'dancing-script'   => array(
			'file'   => 'DancingScript-SemiBold.ttf',
			'family' => 'FG Dancing Script',
		),
	);
