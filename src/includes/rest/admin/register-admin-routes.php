...
class Register_Admin_Routes {
	...
	public static function register() {
		...
		register_rest_route(
			'fotogrids/v1',
			'/admin/albums/(?P<id>\d+)/galleries/(?P<gallery_id>\d+)',
			array(
				array(
		...
		register_rest_route(
			'fotogrids/v1',
			'/admin/albums/(?P<id>\d+)/galleries/reorder',
			array(
				array(
					'methods'             => \WP_REST_Server::CREATABLE,
		...
		register_rest_route(
			'fotogrids/v1',
			'/admin/galleries/(?P<id>\d+)/albums/(?P<album_id>\d+)',
			array(
				array(
					'methods'             => \WP_REST_Server::DELETABLE,
			...
			array(
				...
				array(
					...
					'args'                => array(
						...
						'detect_responsive_by_browser' => array(
							'type'    => 'boolean',
							'default' => false,
						),
					),
