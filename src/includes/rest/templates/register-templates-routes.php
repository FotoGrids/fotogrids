...
class Register_Templates_Routes {
    ...
    public static function register() {
        ...
        register_rest_route( 'fotogrids/v1', '/templates/(?P<id>[a-zA-Z0-9_-]+)/download', array(
            array(
                'methods'  => \WP_REST_Server::READABLE,
        ...
        register_rest_route( 'fotogrids/v1', '/templates/(?P<id>[a-zA-Z0-9_-]+)/apply', array(
            array(
        ...
        register_rest_route( 'fotogrids/v1', '/templates/save', array(
            array(
                'methods'  => \WP_REST_Server::CREATABLE,
        ...
        register_rest_route( 'fotogrids/v1', '/templates/(?P<id>[a-zA-Z0-9_-]+)', array(
            array(
        ...
        register_rest_route( 'fotogrids/v1', '/templates/preview', array(
            array(
                'methods'  => \WP_REST_Server::READABLE,
     ...
     */
    public static function serve_template_preview_html( $served, $result, $request, $server ) {
