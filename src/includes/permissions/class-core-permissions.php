...
final class Core_Permissions {
    ...
    private static function register_logical_caps(): void {
        ...
        Permission_Registry::register( new Permission_Definition( [
            ...
            'group'               => 'gallery',
            'panel'               => 'simple',
            'underlying_caps'     => [ 'modify_fotogrids_gallery_settings' ],
            'default_lowest_role' => 'administrator',
        ] ) );
        ...
        Permission_Registry::register( new Permission_Definition( [
            ...
            'group'               => 'album',
            'panel'               => 'simple',
            'underlying_caps'     => [ 'modify_fotogrids_album_settings' ],
            'default_lowest_role' => 'administrator',
        ] ) );
        ...
        Permission_Registry::register( new Permission_Definition( [
            ...
            'group'               => 'media',
            'panel'               => 'simple',
            'underlying_caps'     => [ 'manage_fotogrids_library' ],
            'default_lowest_role' => 'editor',
        ] ) );
        ...
        Permission_Registry::register( new Permission_Definition( [
            ...
            'group'               => 'stats',
            'panel'               => 'simple',
            'underlying_caps'     => [ 'view_fotogrids_stats' ],
            'default_lowest_role' => 'editor',
        ] ) );
        ...
        Permission_Registry::register( new Permission_Definition( [
            ...
            'group'               => 'plugin',
            'panel'               => 'simple',
            'underlying_caps'     => [ 'manage_fotogrids_settings' ],
            'default_lowest_role' => 'administrator',
        ] ) );
    }
     ...
     * matrix UI.
     */
    private static function humanise_cpt_cap( string $cap, string $kind ): string {
