...
final class Permission_Definition {
    ...
    public function __construct( array $args ) {
        ...
        if ( ! in_array( $this->panel, [ 'simple', 'advanced', 'both' ], true ) ) {
            $this->panel = 'advanced';
        }
    }
    ...
    public function is_logical(): bool {
        return $this->panel === 'simple' && ! empty( $this->underlying_caps );
    }
    ...
    public function set_source( string $source ): void {
        if ( ! in_array( $source, [ 'fotogrids', 'fotogrids-pro', 'third-party' ], true ) ) {
            $source = 'third-party';
        }
        $this->source = $source;
    }
