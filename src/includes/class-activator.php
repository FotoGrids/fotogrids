...
class Activator {
	 ...
	 * - Creates database tables for item metadata, statistics, etc.
	...
	public static function activate() {
		...
		update_option( 'fotogrids_activated_time', time() );
	...
	public static function maybe_upgrade() {
		...
		if ( ! has_action( 'init', array( __CLASS__, 'maybe_resync_capabilities' ) ) ) {
			add_action( 'init', array( __CLASS__, 'maybe_resync_capabilities' ), 8 );
		}
	}
