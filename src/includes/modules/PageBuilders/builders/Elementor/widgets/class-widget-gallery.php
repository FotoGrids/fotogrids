...
class Widget_Gallery extends Widget_Base {
    ...
    public function get_categories(): array {
        return [ Elementor_Module::CATEGORY ];
    }
    ...
    public function get_keywords(): array {
        return [ 'fotogrids', 'gallery', 'photo', 'image', 'grid' ];
    }
    ...
    protected function register_controls(): void {
        ...
        $this->add_control(
            ...
            [
                ...
                'default'     => '',
                'label_block' => true,
                // 'description' => __( 'Pick a FotoGrids gallery, or click Browse all for the full picker.', 'fotogrids' ),
            ]
        );
    ...
    protected function render(): void {
        ...
        echo \FotoGrids\Public_Render::gallery_shortcode( [ // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
            'id'      => $gallery_id,
