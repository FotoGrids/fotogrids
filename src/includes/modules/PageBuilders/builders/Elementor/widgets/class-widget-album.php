...
class Widget_Album extends Widget_Base {
    ...
    public function get_keywords(): array {
        return [ 'fotogrids', 'album', 'gallery', 'photo' ];
    }
    ...
    protected function register_controls(): void {
        ...
        $this->add_control(
            ...
            [
                ...
                'default'     => '',
                'label_block' => true,
                // 'description' => __( 'Pick a FotoGrids album, or click Browse all for the full picker.', 'fotogrids' ),
            ]
        );
    ...
    protected function render(): void {
        ...
        if ( self::is_editor_render() ) {
            ...
            $child_count = class_exists( '\FotoGrids\Gallery_Album_Relations' )
                ? count( (array) \FotoGrids\Gallery_Album_Relations::get_galleries_for_album(
                    $album_id,
