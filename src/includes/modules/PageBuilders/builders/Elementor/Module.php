...
final class Module {
    ...
    public static function init(): void {
        ...
        add_action( 'elementor/controls/register', [ self::class, 'register_controls' ] );
        ...
        add_action( 'elementor/editor/before_enqueue_scripts', [ self::class, 'enqueue_editor_assets' ] );
        ...
        add_filter( Filters_Page_Builders::HAS_CONTENT, [ self::class, 'detect_in_elementor' ], 10, 2 );
        ...
        add_filter( Filters_Render::ANCHOR_ATTRS, [ self::class, 'disable_elementor_lightbox' ], 10, 2 );
        ...
        add_filter( Filters_Render::SHOULD_INLINE_ASSETS, [ self::class, 'inline_assets_in_preview' ] );
    }
    ...
    public static function disable_elementor_lightbox( array $attrs, Render_Context $render ): array {
        if ( $render->meta->source !== Request_Source::ELEMENTOR ) {
            return $attrs;
        }
