...
final class Module {
	...
	public static function init(): void {
		...
		add_action( 'init', array( self::class, 'register_block_assets' ), 15 );
		...
		add_action( 'enqueue_block_editor_assets', array( self::class, 'force_enqueue_editor_assets' ) );
	...
	public static function register_block_assets(): void {
		...
		wp_register_style(
			...
			array( self::STYLE_HANDLE_COLLECTION ),
			FOTOGRIDS_VERSION
		);
	...
	public static function register_blocks(): void {
		...
		foreach ( array( 'gallery', 'album' ) as $block_name ) {
	 ...
	 *
	 * Carries the REST root, the WP nonce, and the URLs to create / edit
