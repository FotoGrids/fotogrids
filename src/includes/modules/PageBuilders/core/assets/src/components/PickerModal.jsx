 ...
 * scroll, keyboard nav, FotoGrids-Pro badges where appropriate.
 *
 * Props:
 *   - kind:        'gallery' | 'album'
...
import { readLicenseState } from '../lib/pro-guard';
...
const PickerModal = ({
    ...
    const [licenseState, setLicenseState] = useState(readLicenseState());
