...
final class Catalog_REST_Endpoint {
	 ...
	 */
	public static function get_field_states( ?string $simulate_state = null, array $warnings = array() ): \WP_REST_Response {
	 ...
	 */
	public static function build_field_states_payload( ?string $simulate_state = null, array $warnings = array() ): array {
		$field_states           = array();
