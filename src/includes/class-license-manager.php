...
class License_Manager {
    ...
    public static function can_use_pro_feature( $can_use, $feature_name ) {
        ...
        if ( $license_response['status'] !== 'valid' ) {
            return false;
        }
    ...
    public static function get_enabled_features() {
        ...
        if ( ! $license_response || $license_response['status'] !== 'valid' ) {
            return array();
        }
    ...
    protected static function get_license_response() {
        // Check cache first
        if ( self::$license_response_cache !== null ) {
        ...
        if ( $last_valid !== false && ( time() - $last_check ) < self::$grace_period ) {
     ...
     */
    public static function clear_cache_on_plugin_change( $plugin, $network_wide ) {
