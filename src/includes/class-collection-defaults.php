...
class Collection_Defaults {
	...
	public static function get_base_defaults( $is_defaults_page = false ) {
		$defaults = array(
			...
			'featured_show_all_focus_bg'                   => 'rgba(255, 255, 255, 1)',
			'featured_show_all_focus_text'                 => 'rgba(0, 0, 0, 1)',
			'featured_show_all_focus_border_color'         => 'rgba(255, 255, 255, 1)',
			'featured_show_all_box_shadow'                 => '',
			// Justified-only.
			...
			'layout_transition_duration_custom'            => 600,
			'layout_easing'                                => 'ease_in_out',
			// Arrows.
			...
			'layout_arrows_at_ends_mode'                   => 'hide',
			// Slider arrow colours (per state). The nav-colors partial supplies
			// the fields; these keys carry the authoritative rgba defaults for
			// the slider's dark-circle arrow style.
			'layout_arrow_bg'                              => 'rgba(0, 0, 0, 0.45)',
			'layout_arrow_border_color'                    => 'rgba(0, 0, 0, 0)',
			'layout_arrow_arrow_color'                     => 'rgba(255, 255, 255, 1)',
			'layout_arrow_hover_bg'                        => 'rgba(0, 0, 0, 0.75)',
			'layout_arrow_hover_border_color'              => 'rgba(0, 0, 0, 0)',
			'layout_arrow_hover_arrow_color'               => 'rgba(255, 255, 255, 1)',
			'layout_arrow_active_bg'                       => 'rgba(0, 0, 0, 0.75)',
			'layout_arrow_active_border_color'             => 'rgba(0, 0, 0, 0)',
			'layout_arrow_active_arrow_color'              => 'rgba(255, 255, 255, 1)',
			'layout_arrow_focus_bg'                        => 'rgba(0, 0, 0, 0.75)',
			'layout_arrow_focus_border_color'              => 'rgba(0, 0, 0, 0)',
			'layout_arrow_focus_arrow_color'               => 'rgba(255, 255, 255, 1)',
			// Image-viewer arrow colours (per state). The viewer arrows sit in a
			// light toolbar: transparent background, dark icon, subtle hover.
			'layout_viewer_arrow_bg'                       => 'rgba(0, 0, 0, 0)',
			'layout_viewer_arrow_border_color'             => 'rgba(0, 0, 0, 0)',
			'layout_viewer_arrow_arrow_color'              => 'rgba(0, 0, 0, 1)',
			'layout_viewer_arrow_hover_bg'                 => 'rgba(0, 0, 0, 0.08)',
			'layout_viewer_arrow_hover_border_color'       => 'rgba(0, 0, 0, 0)',
			'layout_viewer_arrow_hover_arrow_color'        => 'rgba(0, 0, 0, 1)',
			'layout_viewer_arrow_active_bg'                => 'rgba(0, 0, 0, 0.08)',
			'layout_viewer_arrow_active_border_color'      => 'rgba(0, 0, 0, 0)',
			'layout_viewer_arrow_active_arrow_color'       => 'rgba(0, 0, 0, 1)',
			'layout_viewer_arrow_focus_bg'                 => 'rgba(0, 0, 0, 0.08)',
			'layout_viewer_arrow_focus_border_color'       => 'rgba(0, 0, 0, 0)',
			'layout_viewer_arrow_focus_arrow_color'        => 'rgba(0, 0, 0, 1)',
			// Bullets. Geometry keys (layout_bullet_size / _radius /
			// _border_width / _spacing / _align) come from the bullet-geometry
			// partial; the per-state colour fields come from nav-colors. The
			// colour keys below carry the authoritative rgba defaults.
			...
			'layout_bullet_bg'                             => 'rgba(0, 0, 0, 0.4)',
			'layout_bullet_border_color'                   => 'rgba(0, 0, 0, 0)',
			'layout_bullet_hover_bg'                       => 'rgba(0, 0, 0, 0.7)',
			'layout_bullet_hover_border_color'             => 'rgba(0, 0, 0, 0)',
			'layout_bullet_active_bg'                      => 'rgba(60, 70, 240, 1)',
			'layout_bullet_active_border_color'            => 'rgba(0, 0, 0, 0)',
			'layout_bullet_focus_bg'                       => 'rgba(60, 70, 240, 1)',
			'layout_bullet_focus_border_color'             => 'rgba(0, 0, 0, 0)',
			// Thumbnails (slider).
			...
			'thumbnail_filter_amount_grayscale'            => array(
				'desktop' => 50,
				'tablet'  => 50,
				'mobile'  => 50,
			),
			'thumbnail_filter_amount_sepia'                => array(
				'desktop' => 50,
				'tablet'  => 50,
				'mobile'  => 50,
			),
			'thumbnail_filter_amount_blur'                 => array(
				'desktop' => 5,
				'tablet'  => 5,
				'mobile'  => 5,
			),
			'thumbnail_filter_amount_brightness'           => array(
				'desktop' => 100,
				'tablet'  => 100,
				'mobile'  => 100,
			),
			'thumbnail_filter_amount_contrast'             => array(
				'desktop' => 100,
				'tablet'  => 100,
				'mobile'  => 100,
			),
			'thumbnail_filter_amount_saturate'             => array(
				'desktop' => 100,
				'tablet'  => 100,
				'mobile'  => 100,
			),
			'thumbnail_filter_amount_invert'               => array(
				'desktop' => 100,
				'tablet'  => 100,
				'mobile'  => 100,
			),
			'thumbnail_filter_amount_opacity'              => array(
				'desktop' => 100,
				'tablet'  => 100,
				'mobile'  => 100,
			),
			'thumbnail_filter_amount_hue_rotate'           => array(
				'desktop' => 0,
				'tablet'  => 0,
				'mobile'  => 0,
			),
			// Per-filter amount controls (hover/mouseover state).
			'thumbnail_filter_hover_amount_grayscale'      => array(
				'desktop' => 50,
				'tablet'  => 50,
				'mobile'  => 50,
			),
			'thumbnail_filter_hover_amount_sepia'          => array(
				'desktop' => 50,
				'tablet'  => 50,
				'mobile'  => 50,
			),
			'thumbnail_filter_hover_amount_blur'           => array(
				'desktop' => 5,
				'tablet'  => 5,
				'mobile'  => 5,
			),
			'thumbnail_filter_hover_amount_brightness'     => array(
				'desktop' => 100,
				'tablet'  => 100,
				'mobile'  => 100,
			),
			'thumbnail_filter_hover_amount_contrast'       => array(
				'desktop' => 100,
				'tablet'  => 100,
				'mobile'  => 100,
			),
			'thumbnail_filter_hover_amount_saturate'       => array(
				'desktop' => 100,
				'tablet'  => 100,
				'mobile'  => 100,
			),
			'thumbnail_filter_hover_amount_invert'         => array(
				'desktop' => 100,
				'tablet'  => 100,
				'mobile'  => 100,
			),
			'thumbnail_filter_hover_amount_opacity'        => array(
				'desktop' => 100,
				'tablet'  => 100,
				'mobile'  => 100,
			),
			'thumbnail_filter_hover_amount_hue_rotate'     => array(
				'desktop' => 0,
				'tablet'  => 0,
				'mobile'  => 0,
			),
			...
			// Image Viewer stage + control bar (frontend chrome around the image).
			'viewer_stage_bg_color'                        => 'rgba(0,0,0,0.1)',
			'viewer_stage_radius'                          => 6,
			'viewer_stage_border_width'                    => 0,
			'viewer_stage_border_color'                    => 'rgba(0,0,0,0.15)',
			'viewer_bar_bg_color'                          => 'rgba(0,0,0,0.1)',
			'viewer_bar_radius'                            => 6,
			'viewer_bar_border_width'                      => 0,
			'viewer_bar_border_color'                      => 'rgba(0,0,0,0.15)',
			'viewer_bar_gap'                               => 12,
			'viewer_bar_padding'                           => 8,
			...
			// Per-filter amount controls (regular state).
			'full_image_filter_amount_grayscale'           => array(
				'desktop' => 50,
				'tablet'  => 50,
				'mobile'  => 50,
			),
			'full_image_filter_amount_sepia'               => array(
				'desktop' => 50,
				'tablet'  => 50,
				'mobile'  => 50,
			),
			'full_image_filter_amount_blur'                => array(
				'desktop' => 5,
				'tablet'  => 5,
				'mobile'  => 5,
			),
			'full_image_filter_amount_brightness'          => array(
				'desktop' => 100,
				'tablet'  => 100,
				'mobile'  => 100,
			),
			'full_image_filter_amount_contrast'            => array(
				'desktop' => 100,
				'tablet'  => 100,
				'mobile'  => 100,
			),
			'full_image_filter_amount_saturate'            => array(
				'desktop' => 100,
				'tablet'  => 100,
				'mobile'  => 100,
			),
			'full_image_filter_amount_invert'              => array(
				'desktop' => 100,
				'tablet'  => 100,
				'mobile'  => 100,
			),
			'full_image_filter_amount_opacity'             => array(
				'desktop' => 100,
				'tablet'  => 100,
				'mobile'  => 100,
			),
			'full_image_filter_amount_hue_rotate'          => array(
				'desktop' => 0,
				'tablet'  => 0,
				'mobile'  => 0,
			),
			// Per-filter amount controls (hover/mouseover state).
			'full_image_filter_hover_amount_grayscale'     => array(
				'desktop' => 50,
				'tablet'  => 50,
				'mobile'  => 50,
			),
			'full_image_filter_hover_amount_sepia'         => array(
				'desktop' => 50,
				'tablet'  => 50,
				'mobile'  => 50,
			),
			'full_image_filter_hover_amount_blur'          => array(
				'desktop' => 5,
				'tablet'  => 5,
				'mobile'  => 5,
			),
			'full_image_filter_hover_amount_brightness'    => array(
				'desktop' => 100,
				'tablet'  => 100,
				'mobile'  => 100,
			),
			'full_image_filter_hover_amount_contrast'      => array(
				'desktop' => 100,
				'tablet'  => 100,
				'mobile'  => 100,
			),
			'full_image_filter_hover_amount_saturate'      => array(
				'desktop' => 100,
				'tablet'  => 100,
				'mobile'  => 100,
			),
			'full_image_filter_hover_amount_invert'        => array(
				'desktop' => 100,
				'tablet'  => 100,
				'mobile'  => 100,
			),
			'full_image_filter_hover_amount_opacity'       => array(
				'desktop' => 100,
				'tablet'  => 100,
				'mobile'  => 100,
			),
			'full_image_filter_hover_amount_hue_rotate'    => array(
				'desktop' => 0,
				'tablet'  => 0,
				'mobile'  => 0,
			),
			...
			// Shared dropdown typography (drives trigger + popover options).
			'filter_dropdown_font_size'                    => array(
				'desktop' => 14,
				'tablet'  => 14,
				'mobile'  => 13,
			),
			...
			'filter_dropdown_list_bg'                      => 'rgba(255, 255, 255, 1)',
			...
			'pagination_button_focus_bg'                   => 'rgba(60, 70, 240, 0.05)',
			'pagination_button_focus_color'                => 'rgba(0, 0, 0, 1)',
			'pagination_button_focus_border_color'         => 'rgba(60, 70, 240, 1)',
			'pagination_button_radius'                     => 4,
			...
			'lightbox_img_shadow_offset_x'                 => array(
				'desktop' => 0,
				'tablet'  => 0,
				'mobile'  => 0,
			),
			'lightbox_img_shadow_offset_y'                 => array(
				'desktop' => 4,
				'tablet'  => 4,
				'mobile'  => 4,
			),
			'lightbox_img_shadow_blur'                     => array(
				'desktop' => 10,
				'tablet'  => 10,
				'mobile'  => 10,
			),
			'lightbox_img_shadow_spread'                   => array(
				'desktop' => 0,
				'tablet'  => 0,
				'mobile'  => 0,
			),
			...
			'lightbox_toolbar_btn_bg'                      => 'rgba(0, 0, 0, 0)',
			'lightbox_toolbar_btn_border_color'            => 'rgba(0, 0, 0, 0)',
			'lightbox_toolbar_btn_arrow_color'             => 'rgba(255, 255, 255, 0.7)',
			'lightbox_toolbar_btn_hover_bg'                => 'rgba(0, 0, 0, 0)',
			'lightbox_toolbar_btn_hover_border_color'      => 'rgba(0, 0, 0, 0)',
			'lightbox_toolbar_btn_hover_arrow_color'       => 'rgba(255, 255, 255, 1)',
			'lightbox_toolbar_btn_active_bg'               => 'rgba(255, 255, 255, 0.15)',
			'lightbox_toolbar_btn_active_border_color'     => 'rgba(0, 0, 0, 0)',
			'lightbox_toolbar_btn_active_arrow_color'      => 'rgba(255, 255, 255, 1)',
			'lightbox_toolbar_btn_focus_bg'                => 'rgba(0, 0, 0, 0)',
			'lightbox_toolbar_btn_focus_border_color'      => 'rgba(0, 0, 0, 0)',
			'lightbox_toolbar_btn_focus_arrow_color'       => 'rgba(255, 255, 255, 1)',
			'lightbox_navigation_arrow_bg'                 => 'rgba(0, 0, 0, 0.45)',
			'lightbox_navigation_arrow_border_color'       => 'rgba(0, 0, 0, 0)',
			'lightbox_navigation_arrow_arrow_color'        => 'rgba(255, 255, 255, 1)',
			'lightbox_navigation_arrow_hover_bg'           => 'rgba(0, 0, 0, 0.75)',
			'lightbox_navigation_arrow_hover_border_color' => 'rgba(0, 0, 0, 0)',
			'lightbox_navigation_arrow_hover_arrow_color'  => 'rgba(255, 255, 255, 1)',
			'lightbox_navigation_arrow_active_bg'          => 'rgba(0, 0, 0, 0.75)',
			'lightbox_navigation_arrow_active_border_color' => 'rgba(0, 0, 0, 0)',
			'lightbox_navigation_arrow_active_arrow_color' => 'rgba(255, 255, 255, 1)',
			'lightbox_navigation_arrow_focus_bg'           => 'rgba(0, 0, 0, 0.75)',
			'lightbox_navigation_arrow_focus_border_color' => 'rgba(0, 0, 0, 0)',
			'lightbox_navigation_arrow_focus_arrow_color'  => 'rgba(255, 255, 255, 1)',
			'lightbox_thumbnails_background'               => 'rgba(0, 0, 0, 0.7)',
			'lightbox_thumbnail_border_color'              => 'rgba(0, 0, 0, 0)',
			'lightbox_thumbnail_hover_border_color'        => 'rgba(255, 255, 255, 0.45)',
			'lightbox_thumbnail_active_border_color'       => 'rgba(60, 70, 240, 1)',
			'lightbox_thumbnail_focus_border_color'        => 'rgba(60, 70, 240, 1)',
			...
			'lightbox_info_panel_default_state'            => 'open',
			...
			'caption_visibility'                           => 'always',
			'caption_gap'                                  => array(
				'desktop' => 8,
				'tablet'  => 8,
				'mobile'  => 8,
			),
			'caption_title_desc_gap'                       => array(
				'desktop' => 8,
				'tablet'  => 8,
				'mobile'  => 8,
			),
			...
			'view_page_override_defaults'                  => false,
			'view_page_max_width'                          => array(
				'desktop' => array(
					'value' => 60,
					'unit'  => 'vw',
				),
			...
			'view_page_background_color'                   => 'rgba(255, 255, 255, 1)',
	...
	public static function get_gallery_defaults( $is_defaults_page = false ) {
		$defaults = array(
			'single_item_auto_progress'       => false,
			'single_item_auto_progress_delay' => 5,
		);
