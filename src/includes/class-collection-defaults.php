...
class Collection_Defaults {
    ...
    public static function get_base_defaults( $is_defaults_page = false ) {
        $defaults = array(
            ...
            'thumbnail_filter_type' => 'grayscale',
            'thumbnail_filter_amount' => array(
                'desktop' => 50,
                'tablet' => 50,
                'mobile' => 50
            ),
            'thumbnail_filter_blur' => array(
                'desktop' => 5,
                'tablet' => 5,
                'mobile' => 5
            ),
            'thumbnail_filter_hue' => array(
                'desktop' => 0,
                'tablet' => 0,
                'mobile' => 0
            ),
            'thumbnail_filter_hover_amount' => array(
                'desktop' => 50,
                'tablet' => 50,
                'mobile' => 50
            ),
            'thumbnail_filter_hover_blur' => array(
                'desktop' => 5,
                'tablet' => 5,
                'mobile' => 5
            ),
            'thumbnail_filter_hover_hue' => array(
                'desktop' => 0,
                'tablet' => 0,
                'mobile' => 0
            ),
            'full_image_filter_enabled' => false,
            'full_image_filter_type' => 'grayscale',
            'full_image_filter_amount' => array(
                'desktop' => 50,
                'tablet' => 50,
                'mobile' => 50
            ),
            'full_image_filter_blur' => array(
                'desktop' => 5,
                'tablet' => 5,
                'mobile' => 5
            ),
            'full_image_filter_hue' => array(
                'desktop' => 0,
                'tablet' => 0,
                'mobile' => 0
            ),
            'full_image_filter_hover_amount' => array(
                'desktop' => 50,
                'tablet' => 50,
                'mobile' => 50
            ),
            'full_image_filter_hover_blur' => array(
                'desktop' => 5,
                'tablet' => 5,
                'mobile' => 5
            ),
            'full_image_filter_hover_hue' => array(
                'desktop' => 0,
                'tablet' => 0,
                'mobile' => 0
            ),
            ...
            'thumbnail_custom_size_width' => 150,
            'thumbnail_custom_size_height' => 150,
            'thumbnail_custom_size_crop' => false,
            'thumbnail_custom_size_crop_alignment' => 'center',
            'full_image_size' => 'full',
            'full_image_custom_size_width' => 800,
            'full_image_custom_size_height' => 800,
            ...
            'share_reddit' => false,
            'share_email' => true,
            'share_copy_link' => true,
            'sharing_button_style' => 'icons_only',
            'sharing_button_size' => 'medium',
            'sharing_custom_text' => '',
            'sharing_track_clicks' => true,
            'sharing_location' => 'full_images_only',
            'enable_cache' => true,
            'cache_duration' => 24,
