...
class Licensing_Toasts {
    ...
    public static function init(): void {
        add_action( 'fs_after_init_plugin_registered_fotogrids', [ __CLASS__, 'mark_just_opted_in' ] );
        add_action( 'admin_enqueue_scripts', [ __CLASS__, 'maybe_enqueue_pending_toast' ], 99 );
    }
