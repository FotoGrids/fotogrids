module.exports = {
    ...
    rules: {
        ...
        // TypeScript specific rules. An underscore prefix marks a binding as
        // deliberately unused (e.g. `_linked`, skipped destructure slots).
        ...
        // the same warn level rather than the recommended error level. Same
        // underscore-prefix convention for deliberately unused bindings.
        'no-unused-vars': [
            'warn',
            { argsIgnorePattern: '^_', varsIgnorePattern: '^_' },
        ],
